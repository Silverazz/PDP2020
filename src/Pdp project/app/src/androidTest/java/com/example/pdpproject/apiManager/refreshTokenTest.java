...
public class refreshTokenTest {
    ...
    public void exportModels() throws ExecutionException, InterruptedException, JSONException {
        ...
        Singleton.getInstance().setMainAccessToken("123");
        exportSpotifyModelsSyn.addTracksToAppPlaylist(tracks,false);


        ArrayList<Artist> relatedArtists = exportSpotifyModelsSyn.exportRelatedArtists("1Xyo4u8uXC1ZmMpatF05PJ",false);
